...
class Logs_List_Table extends WP_List_Table {
	 ...
	 *
	 * @uses \BrianHenryIE\WP_Autologin_URLs\WP_Logger\Logger_Settings_Interface::get_plugin_slug()
	 */
	 ...
	 * Logger functions.
	 *
	 * @uses \BrianHenryIE\WP_Autologin_URLs\WP_Logger\API_Interface::get_log_files()
	 * @uses \BrianHenryIE\WP_Autologin_URLs\WP_Logger\API_Interface::parse_log()
	 */
