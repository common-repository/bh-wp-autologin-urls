...
namespace BrianHenryIE\WP_Autologin_URLs\WP_Logger\WP_Includes;

use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Admin\Admin_Notices;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Admin\AJAX;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Admin\Logs_Page;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Admin\Plugin_Installer;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Admin\Plugins_Page;
...
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\PHP\PHP_Error_Handler;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\PHP\PHP_Shutdown_Handler;
use BrianHenryIE\WP_Autologin_URLs\WP_Logger\Private_Uploads\URL_Is_Public;
...
class Plugin_Logger_Actions {
	 ...
	 *
	 * @see \BrianHenryIE\WP_Autologin_URLs\WP_Private_Uploads\Admin\Admin_Notices::admin_notices()
	 */
