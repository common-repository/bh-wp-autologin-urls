...
namespace BrianHenryIE\WP_Autologin_URLs\WP_Private_Uploads\API;

use BrianHenryIE\WP_Autologin_URLs\WP_Private_Uploads\API_Interface;
...
class API implements API_Interface {
	...
	/**
	 *
	 * @uses \BrianHenryIE\WP_Autologin_URLs\WP_Private_Uploads\Private_Uploads_Settings_Interface::get_uploads_subdirectory_name()
	 * @uses \BrianHenryIE\WP_Autologin_URLs\WP_Private_Uploads\Private_Uploads_Settings_Interface::get_plugin_slug()
	 *
