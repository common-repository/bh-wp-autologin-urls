...
use BrianHenryIE\WP_Autologin_URLs\GuzzleHttp\Exception\BadResponseException;
use BrianHenryIE\WP_Autologin_URLs\GuzzleHttp\Exception\TooManyRedirectsException;
