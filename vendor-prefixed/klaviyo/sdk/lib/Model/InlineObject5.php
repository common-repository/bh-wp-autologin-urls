 ...
 *
 * @category Class
 * @description The profiles that you would like to remove from the list.   Example:  {   \&quot;emails\&quot;:[\&quot;george.washington@klaviyo.com\&quot;,\&quot;abraham.lincoln@klaviyo.com\&quot;],   \&quot;phone_numbers\&quot;:[\&quot;+13239169023\&quot;],   \&quot;push_tokens\&quot;:[\&quot;03df25c845d460bcdad7802d2vf6fc1dfde97283bf75cc993eb6dca835ea2e2r\&quot;] }
 * @package  Klaviyo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class InlineObject5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setEmails($emails)
    {
        ...
        if (!is_null($emails) && (count($emails) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emails when calling InlineObject5., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPhoneNumbers($phone_numbers)
    {
        ...
        if (!is_null($phone_numbers) && (count($phone_numbers) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone_numbers when calling InlineObject5., number of items must be greater than or equal to 0.');
        }
    ...
    public function setPushTokens($push_tokens)
    {
        ...
        if (!is_null($push_tokens) && (count($push_tokens) < 0)) {
            throw new \InvalidArgumentException('invalid length for $push_tokens when calling InlineObject5., number of items must be greater than or equal to 0.');
        }
