...
class ProfilesApi
{
     ...
     *
     * @param  \BrianHenryIE\WP_Autologin_URLs\Klaviyo\Model\ExchangeRequest $exchange_request exchange_request (optional)
     *
     ...
     * Exchange ID for Profile ID
     *
     * @param  \BrianHenryIE\WP_Autologin_URLs\Klaviyo\Model\ExchangeRequest $exchange_request (optional)
     *
     * @throws \BrianHenryIE\WP_Autologin_URLs\Klaviyo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function exchangeRequest($exchange_request = null)
    {
        ...
        if (isset($exchange_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \BrianHenryIE\WP_Autologin_URLs\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($exchange_request));
            } else {
