...
use BrianHenryIE\WP_Autologin_URLs\Klaviyo\Model\ModelInterface;
use BrianHenryIE\WP_Autologin_URLs\GuzzleHttp\Psr7\Utils;
...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            /** @var \BrianHenryIE\WP_Autologin_URLs\Psr\Http\Message\StreamInterface $data */
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\BrianHenryIE\WP_Autologin_URLs\Klaviyo\Model\\' . $data->{$discriminator};
