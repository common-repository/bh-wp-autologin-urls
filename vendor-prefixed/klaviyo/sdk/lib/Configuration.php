...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://a.klaviyo.com/api';
     ...
     * @var string
     */
    protected $userAgent = 'klaviyo/sdk/1.0.3.20220329';
    ...
    {
        $report  = 'PHP SDK (Klaviyo) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2022.03.29' . PHP_EOL;
